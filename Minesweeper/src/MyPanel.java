...
public class MyPanel extends JPanel {
	...
	public MyPanel() {   //This is the constructor... this code runs first to initialize
		...
		while(mineCount != 0){
				...
				int xRandom = randomGrid.nextInt(10);
				int yRandom = randomGrid.nextInt(10);
				
				
				if(!(numberArray[xRandom][yRandom] == 1 && mineCount != 0)){
					numberArray[xRandom][yRandom] = 1;
...
//-----------------------------------------------------------------------------------------------------------------------------------
//Draw 10 X 10 Grid (TOTAL_COLUMNS X TOTAL_ROWS)
