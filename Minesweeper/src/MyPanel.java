...
public void lostGame(){
	for (int x = 0; x < TOTAL_COLUMNS; x++) {
		...
		int loss = JOptionPane.showConfirmDialog(null, "You lost! Want to play again?", null, JOptionPane.YES_NO_OPTION);
...
public void gameWon(){
	...
	if(TOTAL_GRIDS ==10){
		...
		if(confirmation == JOptionPane.YES_OPTION){
			JOptionPane.showMessageDialog(null, "This part of the code is not ready");
		}
		else{
			JOptionPane.showMessageDialog(null, "Thank You for playing!");
			System.exit(0);
